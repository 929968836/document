...
为了利于项目维护以及规范开发，促进成员之间Code Review的效率，故提出以下开发规范，如有更好建议。
...
例如，请使用`customerStrFirst`和`customerStrLast`，而不要使用`firstCustomerStr`和`lastCustomerStr`。
...
<resources>
    ...
    <dimen name="button_he3423565ight_32">32dp</dimen>
